...
public class MeshDownloader : MonoBehaviour
{
    ...
    IEnumerator downloadMesh() {
      ...
      else
      {
          ...
          StreamWriter writer = new StreamWriter("/Users/jasonlin/Perforce/workspace8151/big chungus/Assets/StaticOBJs/test.txt", true);
          writer.WriteLine(DownloadRequest.downloadHandler.text);
          writer.Close();
          loaded = true;
      }
  }
